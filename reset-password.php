...
<head>
    ...
    <title>Riode -Reset password</title>
...
<body class="contact-us">
    ...
    <div class="page-wrapper">
        ...
        <!-- End Header -->
        <main class="main">
            <div class="page-header" style="background-image: url(images/page-header/reset.jpg)">
            </div>
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-6 d-flex align-items-center mb-4">
                                ...
                                <div class="w-100">
                                    <?php 
                                        if(isset($_GET["reset"])){
                                    ?>
                                    <form class="pl-lg-2"  method="post" action="resetpassword.php">
                                        <h4 class="ls-m font-weight-bold"> CHOICE A NEW PASSWORD </h4>
                                        <p>Please choice et new password*</p>
                                        <div class="row mb-2">
                                            <div class="col-md-6 mb-4">
                                                <input class="form-control" type="email" placeholder="Email *" name="reset_email" required>
                                            </div>
                                        </div>
                                        <div class="row mb-2">
                                            <div class="col-md-6 mb-4">
                                                <input class="form-control" type="password" placeholder="Password *" name="reset_password" required>
                                            </div>
                                        </div>
                                        <div class="row mb-2">
                                            <div class="col-md-6 mb-4">
                                                <input class="form-control" type="password" placeholder="Confirm your password *" name="c_reset_password" required>
                                            </div>
                                        </div>
                                        <button class="btn btn-dark btn-rounded">Send<i
                                                class="d-icon-arrow-right"></i></button>
                                    </form>
                                    <?php
                                        }else{
                                    ?>
                                        <form class="pl-lg-2"  method="post" action="reset.php">
                                        <h4 class="ls-m font-weight-bold"> RESET PASSSWORD </h4>
