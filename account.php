            ...
            <div class="header-top">
                <div class="container">
                    ...
                    <div class="header-right">
                        ...
                        <a class="login-link" href="ajax/login.php" data-toggle="login-modal"><i
                                class="d-icon-user"></i>Sign in</a>
                        <span class="delimiter">/</span>
                        <a class="register-link ml-0" href="ajax/login.php" data-toggle="login-modal">Register</a>
                        <!-- End of Login -->
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6 col-sm-4 col-md-4 col-lg-3">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="shop-left-toggle-sidebar.php">Left Toggle Filter</a>
                                                    </li>
                                                    <li><a href="shop-right-toggle-sidebar.php">Right Toggle
                                                            Sidebar</a></li>
                                                    <li><a href="shop-horizontal-filter.php">Horizontal Filter </a>
                                                    </li>
                                                    <li><a href="shop-navigation-filter.php">Navigation Filter</a></li>

                                                    <li><a href="shop-off-canvas-filter.php">Off-Canvas Filter </a>
                                                    </li>
                                                    ...
                                                    <li><a href="shop-category-in-page-header.php">Category In Page
                                                            Header</a>
                                                </ul>
                                            </div>
                                            <div class="col-6 col-sm-4 col-md-4 col-lg-3">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="shop-infinite-ajaxscroll.php">Infinite Ajaxscroll </a>
                                                    </li>
                                            ...
                                            <div class="col-6 col-sm-4 col-md-4 col-lg-3">
                                                ...
                                                <ul>
                                                    <li><a href="shop-category-grid-shop.php">Category Grid Shop</a>
                                                    </li>
                                                    <li><a href="shop-category+products.php">Category + Products</a>
                                                    </li>
                                                    <li><a href="shop-default-1.php">Shop Default 1 </a></li>
                                                    <li><a href="shop-default-2.php">Shop Default 2</a>
                                                    </li>
                                                    <li><a href="shop-default-3.php">Shop Default 3</a>
                                                    </li>
                                                    <li><a href="shop-default-4.php">Shop Default 4</a>
                                                    </li>
                                                    <li><a href="shop-default-5.php">Shop Default 5</a>
                                                    </li>
                                                    <li><a href="shop-default-6.php">Shop Default 6</a>
                                                    </li>
                                                    <li><a href="shop-default-7.php">Shop Default 7</a>
                                                    </li>
                                                    <li><a href="shop-default-8.php">Shop Default 8</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div
                                                ...
                                                <div class="banner-content y-50">
                                                    ...
                                                    <a href="shop.php" class="btn btn-link btn-underline">shop now<i
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 col-sm-4 col-md-3">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="product-video.php">Video Thumbnail </a></li>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li><a href="shop-category+products.php">Category + Products</a></li>
